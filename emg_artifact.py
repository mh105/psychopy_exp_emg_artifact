...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/alexhe/Library/CloudStorage/Dropbox/Active_projects/PsychoPy/exp_emg_artifact/emg_artifact.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    task_ID_code = 105
    print("Starting experiment: < EMG Artifact Task >. Task ID:", task_ID_code)
